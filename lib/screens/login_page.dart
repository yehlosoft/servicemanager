...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      child: Padding(
        padding: const EdgeInsets.only(left: 60.0, right: 60, top: 150),
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                      ...
                      prefixIcon: Container(
                        ...
                        child: Center(
                            child: Image(
                          image: AssetImage("images/key1.png"),
                          height: 30,
                          color: Colors.white,
                        )),
                      ),
              ...
              Align(
                ...
                child: GestureDetector(
                  ...
                  onTap: () => Navigator.push(context,
                      MaterialPageRoute(builder: (_) => ConfirmMobile())),
                ),
              ),
              SizedBox(
                height: 10,
                  ...
                  child: FlatButton(
                      ...
                      onPressed: () async {
                        ...
                        Navigator.push(
                            context,
                            PageRouteBuilder(
                                pageBuilder: (_, __, ___) => GraphApi(
                                    mobile1: mobile1, password1: password1),
                  ...
                  child: FlatButton(
                      ...
                      onPressed: () async {
                        Navigator.push(
                            context,
                            PageRouteBuilder(
                                pageBuilder: (_, __, ___) => SignUpList(),
                                transitionDuration: Duration(seconds: 0)));
                      }),
                ),
              ),
              ...
              builder: (
                ...
                if (jwt != null) {
                  ...
                  var payload = json.decode(
                      ascii.decode(base64.decode(base64.normalize(avz[1]))));
