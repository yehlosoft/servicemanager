                    ...
                    ? Column(
                      children: [
                        roasterlist("   ongoing   ", widget.getR[i]["setno"], widget.getR[i]["actual_sign_on"],
                            ...
                            Container(height: 1.5,width: double.infinity,color: Color(0XFF8080C5).withOpacity(0.19),),
                        Align(alignment: Alignment.topLeft,
                                                  child: GestureDetector(onTap:()=>Navigator.push(context,MaterialPageRoute(builder: (_)=>
                          
                          AddDuty(did:widget.uid,drid:widget.getR[i]["_id"]))), child: Text(" Add to Duty Records  ",style:TextStyle(backgroundColor: Colors.red[100]))
...
Widget adr(){
 ...
 appBar: new AppBar(automaticallyImplyLeading: false,title:Row(children: [ 
        ...
        topRow(context)]),elevation: 0,backgroundColor: Color(0xFF011627),),      body: Container(height: screenHeight,width: screenWidth,decoration: BoxDecoration(color: Color(0XFFFdFFFC),
        borderRadius: BorderRadius.only(topLeft: Radius.circular(40),topRight: Radius.circular(40),)),
      ...
      child: Padding(padding: const EdgeInsets.fromLTRB(15, 0, 15,0),
                      child: SingleChildScrollView(
                                              child: Column(
                                                children: [
                                                   Padding(padding: const EdgeInsets.all(15),child: head("Search Result"),),
