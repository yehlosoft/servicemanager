        ...
        borderRadius: BorderRadius.only(topLeft: Radius.circular(40),topRight: Radius.circular(40),)),
            child: hbody()),),
              ...
              Align(alignment: Alignment.bottomCenter,child: footer1(
                context:context,
                w1: ()=> Navigator.push(context, PageTransition(curve :Curves.linear,type:PageTransitionType.bottomToTop,child:Profile(fn:fn,ln: ln,eid: eid,mn: mn,))),
                w2: ()=> Navigator.push(context, PageTransition(curve: Curves.linear,type:PageTransitionType.bottomToTop,child:Tower())),
                w3: ()=> Navigator.push(context, PageTransition(curve:Curves.linear,type:PageTransitionType.bottomToTop,child:ChatScreen(ln:ln,fn:fn,ms:ms))),
                w4: ()=> Navigator.push(context, PageTransition(curve:Curves.linear,type:PageTransitionType.bottomToTop,child:SaveScreen())),
               
              )),

              Positioned(bottom:15,left:100,right:100,child: footer2(
                context: context,
                w:()=> Navigator.push(context, PageTransition(type:PageTransitionType.rightToLeftWithFade,child:Search1(uid:uid))),
            ...
            child:Query(options:QueryOptions(document: r"""
              ...
              builder:(  QueryResult result, {Refetch refetch,FetchMore fetchMore,}) {  
                ...
                return Container(height: screenHeight,width: screenWidth,decoration: BoxDecoration(color: Color(0xFFFFFFFF),
                  ...
                  SizedBox(height:10),
                  GestureDetector(
                    onTap:() => Navigator.push(context, PageTransition(type:PageTransitionType.leftToRightWithFade,child:VideoLibrary())),
                    child:_videoLibrary(),),            
                  SizedBox(height:65),
        ]),
    )) ;
...
_videoLibrary() {
  ...
  firstRow() {
    return  Row(mainAxisAlignment: MainAxisAlignment.spaceAround,children: [
      ...
      GestureDetector(
          onTap: () =>Navigator.push(context, PageTransition(type:PageTransitionType.rightToLeftWithFade,child:DutyRecords(uid:uid))),
...
_announcement() {
 ...
 Widget circularBut(String a,input,fixed){
    return GestureDetector(
      onTap: ()=>Navigator.push(context,PageTransition(curve:Curves.linear,type:PageTransitionType.bottomToTop,child:Calculation(a:a,input:input,fixed:fixed))),
...
class CategoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
          onTap: () =>Navigator.push(context, PageTransition(curve:Curves.linear,type:PageTransitionType.rightToLeftWithFade,child:wid)),
