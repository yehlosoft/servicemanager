...
logo(double h, double w) {
  return Center(
      child: Image(
    image: const AssetImage("images/comp.png"),
    color: Color(0XFFFFAC1D1D),
    height: h,
    width: w,
  ));
}
...
title(double h) {
  return Padding(
    ...
    child: Center(
        child: Text(
      "service manager".toUpperCase(),
      style: TextStyle(
          color: Color(0XFFAC1D1D), fontFamily: "Norwester", fontSize: h),
    )),
  );
}
...
brownText(String a, double b) {
  return Text(
    a.toUpperCase(),
    style: TextStyle(
        color: Color(0XFF47525E), fontFamily: "Norwester", fontSize: b),
  );
}
  ...
  return Row(
    ...
    children: [
      ...
      Text('Service Manager',
          style: TextStyle(
              color: Colors.white, fontSize: 20, fontFamily: "Norwester")),
      SizedBox(width: 15),
      Image.asset(
        'images/bell.png',
...
Widget texts(String t1, String t2) {
  return RichText(
      text: TextSpan(
          text: t1 + ": ",
          style: TextStyle(color: Color(0XFF47525E), fontFamily: "Roboto2"),
          children: <TextSpan>[
        TextSpan(
          text: t2,
          style: TextStyle(color: Color(0XFF47525E), fontFamily: "Roboto2"),
